...
tags:
  ...
  - Usage
weight: 1
# cspell:ignore demosite testlink
---
...
4. Create the minimal required Hugo configuration `hugo.toml`. For all configuration options take a look at the [configuration](/posts/usage/configuration/) page.
